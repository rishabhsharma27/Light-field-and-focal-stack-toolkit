...
class VIEW3D_OT_lightfield_setup(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.label(text="Focal Stack Camera parameters:")
        col.prop(LF, "tgt_dir")
        col.prop(LF, "fstop_fs")
        col.prop(LF, "focal_length_fs")
        col.prop(LF, "x_res_fs")
        col.prop(LF, "y_res_fs")
        col.prop(LF, "sensor_size_fs")
        col.prop(LF, "fstack_num")
        col.operator("scene.create_fstack", "Camera", icon="HAND")
        col.operator("scene.render_focalstack", "Render", icon="HAND")
        col.operator("scene.delete_focalstack", "Delete Camera", icon="HAND")
